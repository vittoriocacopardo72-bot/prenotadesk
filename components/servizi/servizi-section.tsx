        ...
        <CardHeader className="gap-3">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <CardDescription>
                Catalogo tour, extra, upgrade e servizi accessori
              </CardDescription>
            </div>
      ...
      <div className="grid gap-6 sm:col-span-2 xl:col-span-4 xl:grid-cols-[1.7fr_0.9fr]">
        <Card className="bg-white">
          <CardHeader>
            ...
            <CardDescription>
              Servizi attivi per tour, charter ed extra a bordo
            </CardDescription>
          </CardHeader>
        ...
        <div className="grid gap-4 content-start">
          <Card className="bg-white" title="Dato dimostrativo">
            <CardHeader>
              ...
              <CardDescription>
                Combinazioni ad alta conversione
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2 text-xs text-slate-700">
              <p className="rounded-md bg-slate-50 px-3 py-2">
                Sunset tour + Prosecco a bordo
              </p>
              <p className="rounded-md bg-slate-50 px-3 py-2">
                Tour costiero + Transfer skipper
              </p>
              <p className="rounded-md bg-slate-50 px-3 py-2">
                Noleggio premium + hostess dedicata
              </p>
            </CardContent>
          </Card>
          <Card className="bg-white" title="Dato dimostrativo">
            <CardHeader>
              ...
              <CardDescription>
                Preferenze clienti ultima settimana
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2 text-xs text-slate-700">
          ...
          <Card className="bg-white" title="Dato dimostrativo">
            <CardHeader>
              ...
              <CardDescription>
                Allineamento rapido team commerciale
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2 text-xs text-slate-700">
              <p className="rounded-md bg-slate-50 px-3 py-2">
                Verificare disponibilita steward per fascia 18:00-20:00.
              </p>
              <p className="rounded-md bg-slate-50 px-3 py-2">
                Aggiornare upsell automatico su noleggio premium.
              </p>
              <p className="rounded-md bg-slate-50 px-3 py-2">
                Promuovere pacchetto sunset nel briefing mattutino.
              </p>
            </CardContent>
          </Card>
        </div>
