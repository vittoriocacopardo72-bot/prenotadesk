...
import { ALTRO_MODULE_ENTRIES, type AltroSectionKey } from "@/lib/mobile/altro-sections"
  ...
  return (
    <Card className="border-slate-200 bg-white shadow-xs" size="sm">
      <CardHeader className="pb-2">
        ...
        <CardDescription>Calendario, meteo, anagrafiche e amministrazione.</CardDescription>
      </CardHeader>
          ...
          return (
            ...
            >
              <span className="flex min-w-0 items-center gap-2">
                {createElement(Icon, { className: "size-4 shrink-0 text-slate-600", "aria-hidden": true })}
