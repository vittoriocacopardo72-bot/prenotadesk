...
export function CompactPreviewCard({
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold tracking-wide text-slate-800 uppercase">{title}</span>
            {badge}
          </div>
      ...
      <div className="pointer-events-none border-t border-slate-100 pt-2">{preview}</div>
    </Button>
  )
}
