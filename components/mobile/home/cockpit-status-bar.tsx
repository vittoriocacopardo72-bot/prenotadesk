...
export function CockpitStatusBar({ tone, line, className }: CockpitStatusBarProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <Badge variant="outline" className="shrink-0 border-slate-200 px-1.5 py-0 text-[10px]">
        Live
      </Badge>
    </div>
  )
