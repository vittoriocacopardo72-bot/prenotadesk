  ...
  return (
    <Card className="bg-white sm:col-span-2 xl:col-span-4">
      <CardHeader>
        ...
        <CardDescription>Crea una prenotazione operativa e aggiorna planning live</CardDescription>
      </CardHeader>
      <CardContent className="grid gap-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            value={form.boatName}
            onChange={(e) => setForm((p) => ({ ...p, boatName: e.target.value }))}
          />
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            min={1}
            value={form.guests}
            onChange={(e) => setForm((p) => ({ ...p, guests: Number(e.target.value || 1) }))}
          />
        </div>
        <div className="space-y-2 xl:col-span-1">
          <Label htmlFor="stato-prenotazione">Stato</Label>
          <Input id="stato-prenotazione" placeholder="In attesa" value="In attesa" readOnly />
        </div>
