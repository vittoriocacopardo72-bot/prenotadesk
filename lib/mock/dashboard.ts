...
export const dashboardAgenda = {
  checkIn: [
    "09:00 Blue Horizon",
    "10:45 Sea Pearl Group",
    "11:30 Vip Concierge Napoli",
  ],
  partenze: ["09:30 Azzurra 44", "10:15 Orion 31", "11:00 Marlin 52"],
  manutenzioni: [
    "14:30 Levante 28 - controllo motore",
    "17:00 Mistral 36 - test impianto",
  ],
  vip: [
    "Famiglia Rinaldi - lounge premium",
    "Charter Aurora - assistenza dedicata",
  ],
...
export const dashboardFinance = [
  {
    label: "Incasso previsto giornata",
    value: "€ 7.240",
    detail: "67% gia confermato",
  },
  {
    label: "Incassi da chiudere",
    value: "€ 1.120",
    detail: "5 transazioni in sospeso",
  },
  {
    label: "Extra venduti",
    value: "23",
    detail: "Prosecco e transfer top richiesta",
  },
...
export const dashboardMarineWidgets = [
  ...
  {
    label: "Livello operativo giornata",
    value: "Alto",
    detail: "78% capacita attiva",
  },
] as const;
